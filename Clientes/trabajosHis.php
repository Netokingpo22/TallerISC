...
<head>
	...
	?>
	<?php
	$sql = "SELECT * FROM idtrabajo WHERE Vehiculo = $i and Estado=0";
									...
									?>
										<tr>
											...
											<td style="text-align: center;">
												<span class="btn btn-info btn-sm" data-toggle="modal" onclick="agregarServicios('<?php echo $mostrar[0] ?>')">
...
<script type="text/javascript">
	function agregarServicios(id, c) {
		...
		$(document).ready(function() {
			...
			localStorage.setItem("ZZZ", "0");
			location.replace("trabajosSerHis.php?n=Trabajo& i=" + id + "& c=" + c);
		});
	}
