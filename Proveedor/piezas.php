					...
					<nav class="navbar navbar-expand-lg navbar-light bg-light">
						...
						<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
							<div class="navbar-nav">
								<a class="nav-item nav-link" href="../Proveedor/proveedor.php">Atras</a>
							</div>
						</div>
					</nav>
				</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="frmnuevo">
						...
						<input type="text" class="form-control input-sm" id="costoc" name="costoc" value="0">
						<label>Costo Proveedor</label>
						<input type="text" class="form-control input-sm" id="costop" name="costop" value="0">
					</form>
				</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="frmnuevoU">
						...
						<label>Costo Cliente</label>
						<input type="text" class="form-control input-sm" id="costocU" name="costocU">
						<label>Costo Proveedor</label>
						<input type="text" class="form-control input-sm" id="costopU" name="costopU">
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
